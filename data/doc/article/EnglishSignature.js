var demo = {
    ...
    data: [{
        ...
        data: [
            ...
            { context: "Wisdom is knowing what to do next; vir is doing it." },
            { context: "知道下一步要做什么是智慧，而行动起来才是美德" },
            { context: "Downwards is the only way forwards" },
            { context: "继续下去是唯一的出路。" },
            { context: "If you don't step fofrward,you're always in the same place." },
            ...
            { context: "If you dont't got after what you want,you'll never have it." },
            ...
            { context: "Know your strengths,user them wisely,and one man can be worth ten thousand" },
