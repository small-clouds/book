var demo = {
    ...
    data: [{
        ...
        data: [
            ...
            { context: "让心中的火苗一直燃烧吧，不管那有多微弱，不管藏得有多深。" },
            { context: "Success doesn't come from what you do occasionally,It comes from what you do consistently." },
            { context: "成功并不来自你偶然做了什么，而是你一直在做什么。" },
            { context: "A tiny change today brings a dramatically different tomorrow." },
            { context: "今天的微小改变，会带来全然不同的明天。" },
            { context: "We connot choose the day or time when we will fully bloom.It happens in its own time." },
            { context: "我们无法选择自己盛开的时日，时候到了，他就会发生的。" },
            { context: "I have failed many times,and that's why I am a success." },
            { context: "我失败过很多次，这就是我成功的原因。" },
            { context: "Believe you can and you're halfway there." },
            { context: "相信自己能成功，你就已经成功了一半。" },
            { context: "Today is your opportunity to build the tomorrow you want." },
            { context: "想要创造出明天，今天就是你的机会。" },
            { context: "The worst loneliness is not to be comfortable with yourself." },
            { context: "最糟糕的孤独是无法舒适的和自己相处。" },
            { context: "I have found that if you love life,life will love you back." },
            { context: "我发现，如果你爱生活，生活也会用爱来回报你。" },
            { context: "I will love the light for it shows me the way,yet I will endure the dark for it shows me the stars." },
            { context: "我将热爱光明，因为他为我指明道路，而我将忍受黑暗，因为他向我展示繁星。" },
            { context: "Never assume that you're stuch with the way things are.life changes,and so can you." },
            { context: "永远别认为你无法摆脱现状，人生会改变，你也会。" },
            { context: "You never find yourself until you face the truth." },
            { context: "面对现实才能认清自我。" },
            { context: "A dream that you don't fight for can haunt you for the rest of your life." },
            { context: "没有为之奋斗的梦想会纠缠你一辈子。" },
            { context: "There is ugliness in this world,disarray.I choose to see the beauty." },
            { context: "这世上却有丑恶与混乱，而我选择看到美好。" },
            { context: "Wherever you go,no matter what the weather,always bring your own sunshine." },
            { context: "无论去哪儿，无论天气怎样，记得带上自己的阳光。" },
            { context: "When something is important enough,you do it even if the odds are not in your favor." },
            { context: "当一件事情足够重要时，几遍缺乏胜算，你也会去做。" },
            { context: "Knowledge speaks,but wisdowm listens." },
            { context: "知识会说话，但智慧是会倾听。" },
            { context: "Happy people build their inner world.Unhappy people blame their outer world." },
            { context: "快乐的人建构内心世界，不快乐的人责怪外在世界。" },
            { context: "He who would travel happily must travel light." },
            { context: "想要快乐旅行的人必须轻装上阵。" },
            { context: "I love you not only for what you are,but for what I am when with you." },
            { context: "我爱你，不仅仅因为你是什么样的人，还因为和你在一起时，我可以变成什么样。" },
            { context: "The guy who takes a chance,who walks the line between the know and unknow,who is unafraid of failure,will succeed." },
            { context: "敢于冒险的人，游走在已知和未知之间的人，不怕失败的人，才会成功。" },
            { context: "In order to be irreplaceable one must always be different." },
            { context: "要想变得无可替代，就必须与众不同。" },
            { context: "Little by little,one travels far." },
            { context: "跬步之积，也可大千里。" },
            { context: "The farther behind I leave the past,the closer I am to forging my own character." },
            { context: "我把过去跑的越远，便越接近于我自己锻造的自我。" },
            { context: "Youth is not a time of life;it is a state of mind." },
            { context: "青春不是年华，而是心境。" },
            { context: "Anything looked at closely becomes wonderful." },
            { context: "在近距离的观察下，任何事物都会显得美妙无比。" },
            { context: "Love yourself first and everything else falls into line." },
            { context: "要先爱你自己，这样其他的一切才会步入正轨。" },
            { context: "Noting is too small to know,and nothing is too big to attempt." },
            { context: "没有事情会小到不值得了解，也没有什么事情会大到无法尝试。" },
            { context: "Yesterday is but today's memory,tomorrow is today' dream." },
            { context: "昨日不过是今日的会议，明天确是今天的梦想" },
            { context: "I think it's the books that you read when you're young that live with you forever" },
            { context: "我想，你年轻时读过的书，才会陪伴你一生一世" },
            { context: "Spring is the time of plans and projects." },//20200420
            { context: "春日适于开启计划和安排。" },
            { context: "The whole point in being a hero ti to do something greater than yourself." },
            { context: "做一名英雄，关键在于，要做出超越你自身的伟大之举。" },
            { context: "If you don't value your time,neither will others." },
            { context: "如果你不珍惜自己的时间，别人也不会珍惜" },
            { context: "Putting off an easy ting makes it hard, and putting off a hard one makes it impossible." },
            { context: "简单的事，越拖越难，困难的事，越拖越不可能做。" },
            { context: "Respect yourself enough to walk away from anything that no longer serves you,grows you,or makes you happy." },
            { context: "尊重自己，远离那些不在对你就用、不在让你成长火快乐的事。" },
            { context: "kindness is always fashionable,and always welcome." },
            { context: "善良，永不过时，也永远为人所喜闻乐见。" },
            { context: "Whatever you do in life,remeber:think higher and feel deeper.It cannot be bad if you do that." },
            { context: "生活中不管做什么事，记住：思考角度要更高，感知要更深刻，这样做事绝对不会有坏处的。" },
            { context: "Lose an hour in the morning,and you will spend all day looking for it." },
            { context: "早上浪费一小时，得用一天的时间来弥补。" },
            { context: "Do something wonderful;people may imitate it." },
            { context: "去做美好的事，人们可能会效仿。" },
            { context: "You can't cross the sea merely by standing and staring at the water." },
            { context: "光站在那里盯着海绵，是没法穿越海洋的。" },
            { context: "Happiness,it comes on unexpectedly.And goes beyond,really,any early morning talk about it ." },
            { context: "幸福，在不经意间降临，他着实胜过每个谈论幸福的清晨。" },
            { context: "They awlays say time changes things,but you actually have to change them yourself." },
            { context: "人们总说时间会改变一切，单改变还是要靠你自己。" },
            { context: "Take chances;make mistakes.That's how you grow." },
            { context: "去冒险，去犯错。你就是这样成长起来的。" },
            { context: "People may hear your words,but they feel your attitude." },
            { context: "你的话别人能听到，单你的态度才是别人能感受到的。" },
            { context: "If you saturate your mind with positive thoughts,it will sustain you in any situation." },
            { context: "让大脑装满积极的想法，能支撑你度过任何境遇。" },
            { context: "Keep your best wishes close to your heart and watch what happens." },
            { context: "心怀最美好的愿望，再看看会发生什么。" },
            { context: "The world needs dreamers and the world needs doers.But above all,the world needs dreamers who do." },
            { context: "世界需要梦想家，也需要实践者，单着世界最需要的是能实践的梦想家。" },
            { context: "If you love somebody,let them go,for if they return,they were always yours.If they don't,they never were." },
            { context: "爱一个人，就要放手；若能回来，便永远属于你；若没回来，便从未属于过你。" },
            { context: "There is a pleasure in the pathless woods;there is a rapture on the lonely shore." },
            { context: "无径之林，常有乐趣；无人之岸，几多欢喜。" },
            { context: "Half of the troubles of this life can be traced to saying yes too quickly and not saying no soon enough." },
            { context: "生活中有半数烦恼，来自于答应得太快和拒绝得太慢。" },
            { context: "The landscape belongs to the person who looks at it." },
            { context: "风景属于那些看风景的人。" },
            { context: "We first make our habits,then our habits make us." },
            { context: "我们养成习惯，接着习惯成就我们。" },
            { context: "Give whatever you are doing and whoever you are with the gift of your attention." },
            { context: "无论在做什么，跟谁相处，都要送出这份礼物：保持专注。" },
            { context: "It's faith that will take you through,and determination that will drive you." },
            { context: "信念带你度过难关，决心为你加油鼓劲" },
            { context: "Never lose hope.Storms make people stronger and never last forever." },
            { context: "永远怀抱希望。暴风雨会让人更加坚强，而且不会恒久长存。" },
            { context: "No matter what you're going through,there's a light at the end of the tunnel." },
            { context: "无论你正在经历什么，隧道尽头总会有光。" },
            { context: "One has to be positive.When you're positive good things happen." },
            { context: "你要乐观，拟以乐观，好事就会发生。" },
            { context: "No matter what happens,or how bad it seems today,life does go on,and it will be better tomorrow" },
            { context: "不管发生什么，不管今天看起来多么糟糕，生活都会继续，明天会更好。" },
            { context: "Keep your fears to yourself,but share your courage with others." },
            { context: "把恐惧留在自己心里，把勇气分享给他人。" },
            { context: "Once you choose hope,anything's possible." },
            { context: "一旦你怀抱希望，一切就都有可能。" },
            { context: "Sometimes things become possible if we want them bad enough." },
            { context: "有时候，只要我们的渴望足够强烈，心想就会事成。" },
            { context: "Life is a mirror:if you frown at it, it frowns back; if you smile,it returns the greeting." },
            { context: "生活是一面镜子，你对他皱眉，他就会对你眉头紧皱‘你对他微笑，他就会对你笑脸相迎。" },
            { context: "Have you ever seen Los Angeles at 4 a.m.?" },
            { context: "你见过凌晨四点的洛杉矶吗？" },
            { context: "Sometimes you have to travel a long way to find what is near." },
            { context: "有时候，要走很远才能发现，是什么一直陪伴在身边。" },
            { context: "To acquire the habit of reading is to construct for yourself a refuge from almost all the miseries of life." },
            { context: "养成阅读的习惯，就是给自己建造避难所，抵挡人生几乎所有不幸。" },
            { context: "Sometimes the most urgent and vital thing you can possibly do it take a complete rest." },//20200120
            { context: "有时候，你能做的最紧急、最重要的是就是彻底的休息一下。" },
            { context: "Argue for your limitations, and sure enough they're yours." },
            { context: "为你的局限而辩解，那你就真的把自己局限在里面了。" },
            { context: "Character may be manifested in the great moments,but it is made in the small ones." },
            { context: "品格彰显于重要时刻，却培养与日常琐事中。" },
            { context: "The trouble with talking too fast is you may say something you haven't thought of yet." },
            { context: "说话太快的问题是，你说出口的可能是你还没考虑过的。" },
            { context: "Either you run the day or the day runs you." },
            { context: "你不主宰时光，时光就会主宰你。" },
            { context: "The universe has a way of leading you to where you're supposed to be." },
            { context: "命运会把你引致你该到的地方去" },
            { context: "The wisest mind has something yet to learn." },
            { context: "即便最有智慧的人，也还有要学习的地方。" },
            { context: "Withstanding the cold develops vigor for the relaxing days of spring and summer." },//20200106
            { context: "耐住寒冷，能生出活力，以迎接轻松的春夏时节。" },
            { context: "Happy is the man who can make a living by his hobby." },
            { context: "以爱好谋生的人是幸福的。" },
            { context: "It is difficulties that show what men are" },
            { context: "困难面前方显品质。" },
            { context: "cheers to a new year and another chance for us to get it right" },
            { context: "为新的一年，为我们又有机会走向正轨，干杯！！！" },
            { context: "If you're brave enough to say goodbye,life will reward you with a new hello." },
            { context: "只要你勇敢的说再见，生活便会奖励你新的开始。" },
            { context: "If you don't have anything,you have to act like you own everything." },
            { context: "如果你一无所有，那就要当做无所不有。" },
            { context: "We are made to persist. that's how we find out who we are." },
            { context: "我们生来就是为了坚持，这样我们才能弄清自己是谁。" },
            { context: "The best love id the kind that awakens the soul and makes us reach for more." },
            { context: "最好的爱，唤醒我们的灵魂，让我们更有追求。" },
            { context: "A real loser is someone who's so afraid of not winning;they don't even try." },
            { context: "真正失败的人，是那种特别害怕不成功，连试都不敢试的人。" },
            { context: "It's you, on your own,pick up the pieces and starting over." },
            { context: "凭借你自己的力量，捡起碎片，从头再来。" },
            { context: "The ones who love us never really leave us;you can always find them in here." },
            { context: "爱我们的人永远不会真正离开，他们会一直存在你的心里。" },
            { context: "What good is the warmth of summer,without the cold of winter to give it sweetness." },
            { context: "不历冬日严寒，怎知暖夏美好。" },
            { context: "May the odds be ever in your favor." },
            { context: "愿好运永远眷顾你。" },
            { context: "If you want to be loved,you have to be worth loving." },
            { context: "如果你希望被人爱，那你要先值得人家爱你。" },
            { context: "To do a common thing uncommonly well brings success" },
            { context: "将平凡的事情做的不同凡响，就能带来成功。" },
            { context: "If you've got a talent,protect it." },//20191213
            { context: "如果你有天赋，要去保护它。" },
            { context: "To know yourself is the first and most important step in the process of pursuing your dreams and goals." },
            { context: "了解自己，是追求梦想及目标的第一步，也是最重要的一步。" },
            { context: "If you have great talents,industry will improve them." },
            { context: "如果你很有天赋，勤勉会使其更加完善" },
            { context: "Develop a passion for learning.If you do, you will never cease to grow." },
            { context: "培养你对学习的热情，如此，你将永远不会停止成长。" },
            { context: "Waste no more time arguing about what a good man should be. Be one" },
            { context: "别再浪费时间去争论何为好人，去成为一个好人吧。" },
            { context: "Patience and diligence,like faith ,remove mountains." },//20191119
            { context: "如同信念一样，耐心和勤奋也可以金石为开" },
            { context: "Dwell on the beauty of life.Watch the stars, and see yourself running with them." },
            { context: "细想生活之美，遥望星辰，想想自己在其中遨游。" },
            { context: "Always walk through life as if you have something new to learn ,and you will." },
            { context: "生活中无论何时都做好学习新事物的准备，你就能有所有" },
            { context: "The soul that sees beauty may sometimes walk alone." },
            { context: "看见美的灵魂，有时只能独行。" },
            { context: "perfection does not exist;you can always do better and you can always grow." },
            { context: "完美并不存在，，你永远可以做的更好，并不断获得成长。" },
            { context: "In youth we learn ;in age we understand." },
            { context: "少而学，长而知。" },
            { context: "If you have good thoughts,they will shine out of your face like sunbeams and you will always look lovely." },
            { context: "你若思想美好，面容就会如阳光般灿烂，看上去永远可爱迷人。" },
            { context: "If we had no winter ,the spring would not be so pleasant." },
            { context: "如果没有冬天，春天就不会如此悦人。" },
            { context: "How we spend our days is,how we spend our lives." },
            { context: "我们如何度过每一天，当然也就会如何度过一生。" },
            { context: "Defeat is not the worst of failures. Not to have tried is the true failure." },
            { context: "被击倒不是最大的失败，不曾尝试过才是真正的失败。" },
            { context: "This path has been placed before you.The choice is yours alone." },
            { context: "路就在你脚下，你自己决定。" },
            { context: "Don't go through life;grow through life." },
            { context: "别只是生活，要通过生活获得成长。" },
            { context: "Luck is the sense to recognize an opportunity and the ability to take advantage of it." },
            { context: "运气就是有意识去辨别机会，并能够利用机会。" },
            { context: "The only safe thing is to take a chance." },
            { context: "唯一稳妥的事是去冒险一试。" },
            { context: "All men who have achieved great things have been great dreamers" },
            { context: "一直以来，凡成大事者都是大梦想家。" },
            { context: "The superme happiness of life is the conviction that we are loved." },
            { context: "人生最大的幸福，就是坚信有人爱我们。" },
            { context: "Human beings can alter their lives by altering their attitude of mind." },
            { context: "人若改变心态，便能改变生活" },
            { context: "Today I will do what others won't,so tomorrow I can accomplish what others can't." },
            { context: "今日我愿做他人不愿做的，明日我会做成他人做不到的。" },
            { context: "Character is what you know you are,not what others think you have." },
            { context: "个性是你所了解的自己，而不是别人眼中的你。" },
            { context: "A wise man will make more opportunities" },//20191014
            { context: "智者创造的机会要比发现的多。" },
            { context: "Wisdom is knowing what to do next; virtue is doing it." },
            { context: "知道下一步要做什么是智慧，而行动起来才是美德" },
            { context: "Downwards is the only way forwards" },
            { context: "继续下去是唯一的出路。" },
            { context: "If you don't step forward,you're always in the same place." },
            { context: "不向前迈步，你将永远在原地踏步" },
            { context: "You are the softness of the morning dew." },
            { context: "你，恰似晨露的温柔" },
            { context: "Goodness is the only investment that never fails." },
            { context: "善良是唯一不会失败的投资" },
            { context: "It is not the destination so much as the journey,they say." },
            { context: "人们说，旅行的目的地不如旅程来的重要" },
            { context: "You never know how far you can go unless you run" },
            { context: "你如果不跑起来，就永远不知道自己能走多远" },
            { context: "If you want the best the world has to offer,offer the world your best." },
            { context: "若想得到世界上最好的东西，先向世界展现最好的你。" },
            { context: "If we're kind and polite,the world will be right." },
            { context: "如果我们温和善良、彬彬有礼的话，世界将会变美好。" },
            { context: "If you want the rainbow ,you have to deal with the rain." },
            { context: "想要彩虹，得先忍受雨水" },
            { context: "I wouldn't give up being myself for even one second." },
            { context: "我不会放弃做自己，哪怕一秒也不行。" },
            { context: "Silence is the sleep that nourishes wisdom." },
            { context: "沉默，好比睡眠，会滋养出智慧。" },
            { context: "Whatever is worth doing at all is worth doing well." },
            { context: "任何值得做的事，都值得将其做好。" },
            { context: "Water can carve its way even through stone and when trapped,water makes a new path." },
            { context: "水滴能穿石，即便困于一隅，也能另辟蹊径." },
            { context: "I think togetherness is a very important ingredient to family life." },
            { context: "在我看来，团聚于家庭生活而言不可或缺" },
            { context: "Keep your head up in failure, and your head down in success." },
            { context: "失败是，要高昂起头；成功时，要保持谦逊。" },
            { context: "Good teachers , they inspire you, they entertain you, and you end up learning a ton even when you don't know it." },
            { context: "好的老师会激励你，给你带来欢乐，悄然无声地教会你很多东西." },
            { context: "If you don't got after what you want,you'll never have it." },
            { context: "不去追逐你所渴求的，你就永远也无法拥有它." },
            { context: "Whatever happens tomorrow，we've had today." },
            { context: "不管明天会发生什么，至少我们拥有今天" },
            { context: "It's what you do right now that makes a difference." },
            { context: "你现在所做的是改变现状的关键" },
            { context: "Sometimes a problem is just an opportunity in disguise." },
            { context: "有时候问题不过是伪装起来的机会。" },
            { context: "Worse than not realizing the dreams of your youth would be to have been young and never dreamed at all." },
            { context: "比未能实现的梦想还糟糕的是年轻根本就没有梦想" },
            { context: "There are no easy answers;there's only living through the questions." },
            { context: "生活没有容易的答案，只有去克服困难重重." },
            { context: "A bird is safe in its nest ,but tat is not what its wings are made for." },
            { context: "小鸟在巢中最安全，但翅膀可不是为此而生的." },
            { context: "If you focus on results, you will never change.If you focus on change ,you will get results." },
            { context: "如果你专注于结果，那么你永远不会有该县。如果你专注于改变，你将自然获得结果." },
            { context: "Know your strengths,use them wisely,and one man can be worth ten thousand" },
            { context: "认清自己的长处，并善加利用，一人可抵万人" },
            { context: "There's no great loss without some small gain." },
            { context: "凡重大的损失都必然会有所益处。" },
            { context: "It's the possibility of having a dream come true that makes life  interesting." },
            { context: "梦想有可能成为现实，生活正是因此而有趣" },
            { context: "It's so easy to be careless.It takes courage and character to care." },
            { context: "要不在乎很容易，但在乎却需要勇气和品质." },
            { context: "It's very simple to be happy,but it is very difficult to be simple." },
            { context: "快乐很简单，但要做到简单确很困难." },
            { context: "Not he who has much is rich,but he who gives much." },
            { context: "富有的人不是拥有得多，而是给予的多." },
            { context: "Worry does not empty tomorrow of its sorrow。it empties today its strength." },
            { context: "忧虑不会消除明天的痛苦，只会削弱今天的力气." },
            { context: "It is one thing to be clever and another to be wise." },
            { context: "聪明和智慧是两码事." },
            { context: "True happiness is of a retired nature and an enemy to pomp and noise." },
            { context: "真正的幸福不显山不露水，他会摒弃一切浮华和喧嚣." },
            ...
            { context: "守不住的承诺就别说." },
            { context: "There are many ways of going forward, but only one way of standing still." },
            ...
            { context: "Work hard,stay positive,and get up early.it's the best part of the day." },
            ...
            { context: "努力做自己不在乎的事叫做压力；努力做自己喜爱的事情叫做激情" },
            ...
            { context: "怎样度过你的一生是你自己的事，但请谨记，身体和灵魂只赋予你一次。" },
            ...
            { context: "What makes you different or weird ,that's your strength" },
            ...
            { context: "你会明白，人生中最美好的事，莫过于爱的同时也被爱。" },
            ...
            { context: "Look at the stars; look how they shine for you and everything you do." },
            ...
            { context: "Courage is fear holding on a minute longer" },
            ...
            { context: "listen to what you know instead of what you fear" },
            ...
            { context: "Mortal body; timeless souls" },
            ...
            { context: "全世界都在你的脚下" },
            { context: "Sometimes the right path is not the easiest one." },
            { context: "有时候，正确的道路并不是最好走的那条" },
            { context: "Hard work beats talent when talent fails to work hard" },
            ...
            { context: "Success is the sum of small efforts repeated day in and day out" },
            ...
            { context: "There are tens of millions of love in the world, and I love you less than I love you." },
            { context: "世间的爱有千千万，也不及我爱你，从今往后，有增无减" },
